                ...
                Section {
                                        VStack {
                                            Spacer()
                                                ...
                                                .clipped()
                                            Link("Inject to saved App ID", destination: URL(string: "sidestore://sidejit-enable?bid=\(appid3)")!).buttonStyle(ButtonFromInteractfulROFL())
                                                .disabled(appid3 == (""))
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                    ...
                                    Section {
                                        VStack {
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                            Link("Inject to saved App ID", destination: URL(string: "sidestore://sidejit-enable?bid=\(appid4)")!).buttonStyle(ButtonFromInteractfulROFL())
                                                .disabled(appid4 == (""))
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                    ...
                                    Section {
                                        VStack {
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                            Link("Inject to saved App ID", destination: URL(string: "sidestore://sidejit-enable?bid=\(appid5)")!).buttonStyle(ButtonFromInteractfulROFL())
                                                .disabled(appid5 == (""))
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                    ...
                                    Section {
                                        VStack {
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                            Link("Inject to saved App ID", destination: URL(string: "sidestore://sidejit-enable?bid=\(appid6)")!).buttonStyle(ButtonFromInteractfulROFL())
                                                .disabled(appid6 == (""))
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                    ...
                                    Section {
                                        VStack {
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                            Link("Inject to saved App ID", destination: URL(string: "sidestore://sidejit-enable?bid=\(appid7)")!).buttonStyle(ButtonFromInteractfulROFL())
                                                .disabled(appid7 == (""))
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                    ...
                                    Section {
                                        VStack {
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                            Link("Inject to saved App ID", destination: URL(string: "sidestore://sidejit-enable?bid=\(appid8)")!).buttonStyle(ButtonFromInteractfulROFL())
                                                .disabled(appid8 == (""))
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                    ...
                                    Section {
                                        VStack {
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                            Link("Inject to saved App ID", destination: URL(string: "sidestore://sidejit-enable?bid=\(appid9)")!).buttonStyle(ButtonFromInteractfulROFL())
                                                .disabled(appid9 == (""))
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                    ...
                                    Section {
                                        VStack {
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
                                            Link("Inject to saved App ID", destination: URL(string: "sidestore://sidejit-enable?bid=\(appid10)")!).buttonStyle(ButtonFromInteractfulROFL())
                                                .disabled(appid10 == (""))
                                            Spacer()
                                                .frame(width: 0, height: 10)
                                                .clipped()
